...
System.register("utils/misc", ["engine/ObjectSkin", "engine/StaticGameObject", "engine/ObjectPhysics"], function (exports_5, context_5) {
    ...
    exports_5("distanceTo", distanceTo);
    ...
    return {
        ...
        execute: function () {
            Item = class Item extends SceneObject_1.SceneObject {
                ...
                new() {
                    return new Item([0, 0], new ObjectSkin_2.ObjectSkin(), new ObjectPhysics_2.ObjectPhysics(), [0, 0]);
                }
            };
            exports_6("Item", Item);
        }
...
System.register("engine/Scene", ["engine/GameEvent", "main", "engine/Cell", "engine/EventLoop", "engine/GraphicsEngine", "engine/Npc", "engine/SceneBase"], function (exports_8, context_8) {
    ...
    return {
        ...
        execute: function () {
            ...
            bedrockCell = new Cell_1.Cell(' ', 'transparent', '#331');
                        ...
                        if (scene.weatherTicks > 300) {
                            ...
                            function createCell(x, y) {
                                if (scene.weatherType === 'rain') {
                                    ...
                                    addCell(new Cell_1.Cell(sym, 'cyan', '#0000'), x, y);
                                }
                                else if (scene.weatherType === 'snow') {
                                    const r = (Math.random() * 6 | 0);
                                    if (r === 0)
                                        addCell(new Cell_1.Cell('❄', 'white', 'transparent'), x, y);
                                    else if (r === 1)
                                        addCell(new Cell_1.Cell('❅', 'white', 'transparent'), x, y);
                                    else if (r === 2)
                                        addCell(new Cell_1.Cell('❆', 'white', 'transparent'), x, y);
                                    ...
                                    if (r === 1)
                                        ...
                                        addCell(new Cell_1.Cell('`', 'cyan', 'transparent'), x, y);
                                }
                                else if (scene.weatherType === 'mist') {
                                    if ((Math.random() * 2 | 0) === 1)
                                        addCell(new Cell_1.Cell('*', 'transparent', '#fff2'), x, y);
                                }
                            }
                        }
                    }
                    ...
                    function drawLights() {
                        for (let y = 0; y < main_1.viewHeight; y++) {
                            for (let x = 0; x < main_1.viewWidth; x++) {
                                ...
                                GraphicsEngine_1.drawCell(ctx, new Cell_1.Cell(' ', undefined, `#000${(15 - lightLevel).toString(16)}`), x, y);
                            }
                        }
                    }
                }
        ...
        execute: function () {
            ...
            CanvasContext = class CanvasContext {
                ...
                drawCellInfo(topPos, leftPos, cellInfo) {
                    ...
                    //
                    const left = main_2.leftPad + leftPos * cellStyle.size.width;
                    const top = main_2.topPad + topPos * cellStyle.size.height;
                    //
        ...
        execute: function () {
            SceneBase = class SceneBase {
                ...
                draw(ctx) {
                    ...
                    GraphicsEngine_2.drawObjects(ctx, this.objects);
                }
                // extra
                isPositionBlocked(position) {
                    for (let object of this.objects) {
                        ...
                        if (GraphicsEngine_2.isCollision(object, pleft, ptop)) {
                            return true;
                        }
                    }
                    return false;
            ...
            exports_11("SceneBase", SceneBase);
        }
    };
});
System.register("engine/SceneObject", ["engine/ObjectSkin", "engine/ObjectPhysics"], function (exports_12, context_12) {
    ...
    return {
        ...
        execute: function () {
            ...
            exports_12("SceneObject", SceneObject);
        }
    };
});
    ...
    return {
        ...
        execute: function () {
            StaticGameObject = class StaticGameObject extends SceneObject_3.SceneObject {
                ...
                new() { return new StaticGameObject([0, 0], new ObjectSkin_5.ObjectSkin(), new ObjectPhysics_5.ObjectPhysics(), [0, 0]); }
            };
...
System.register("world/levels/glitch", ["engine/StaticGameObject", "engine/ObjectSkin", "engine/ObjectPhysics", "world/hero"], function (exports_17, context_17) {
    ...
    return {
        ...
        execute: function () {
            SimpleGlitch = class SimpleGlitch extends StaticGameObject_3.StaticGameObject {
                constructor(hiddenFrames, idleFrames, clickFrames, trigger, button) {
 ...
 a`, {
            ...
            exports_17("SimpleGlitch", SimpleGlitch);
            exports_17("glitch1", glitch1 = new class Glitch1 extends SimpleGlitch {
                constructor() {
                    super({
                        450: [
...
System.register("world/objects/natural", ["engine/StaticGameObject", "engine/ObjectSkin", "engine/ObjectPhysics"], function (exports_19, context_19) {
    ...
    return {
        ...
        execute: function () {
            createUnitSkin = (sym, color = 'black') => new ObjectSkin_10.ObjectSkin(sym, `u`, {
                u: [color, 'transparent'],
            });
            unitPhysics = new ObjectPhysics_9.ObjectPhysics(` `);
            createUnitStaticObject = (sym, color = 'black') => new StaticGameObject_4.StaticGameObject([0, 0], createUnitSkin(sym, color), unitPhysics);
            exports_19("flower", flower = createUnitStaticObject(`❁`, 'red'));
            exports_19("wheat", wheat = createUnitStaticObject(`♈`, 'yellow'));
            exports_19("hotspring", hotspring = createUnitStaticObject(`♨`, 'lightblue'));
            exports_19("duck", duck = createUnitStaticObject(`🦆`, 'white'));
            exports_19("bamboo", bamboo = new StaticGameObject_4.StaticGameObject([0, 4], new ObjectSkin_10.ObjectSkin(`▄
█
█
█
█
...
D`, {
    ...
    .`, ``), [0, 0]));
            Tree = class Tree extends StaticGameObject_4.StaticGameObject {
                constructor() {
                    super([1, 3], new ObjectSkin_10.ObjectSkin(` ░ 
░░░
░░░
 █`, ` o 
o01
01S
 ...
 .`, ''), [2, 12]);
            ...
            ;
            exports_19("tree", tree = new Tree());
            SakuraTree = class SakuraTree extends StaticGameObject_4.StaticGameObject {
                constructor() {
                    super([2, 3], new ObjectSkin_10.ObjectSkin(` ░░ 
░░░░
 ░░
  █`, ` oo 
o01o
 ...
 .`, ''), [2, 12]);
            ...
            ;
            exports_19("sakura", sakura = new SakuraTree());
        }
    };
});
System.register("world/npc/Bee", ["engine/Npc", "engine/ObjectSkin"], function (exports_20, context_20) {
    ...
    return {
        ...
        execute: function () {
            Bee = class Bee extends Npc_3.Npc {
                constructor() {
...
System.register("world/objects/artificial", ["engine/StaticGameObject", "engine/ObjectSkin", "engine/ObjectPhysics"], function (exports_21, context_21) {
    ...
    return {
        ...
        execute: function () {
            exports_21("vFence", vFence = new StaticGameObject_5.StaticGameObject([0, 0], new ObjectSkin_12.ObjectSkin(`☗`, '.', { '.': ['Sienna', 'transparent'] }), new ObjectPhysics_10.ObjectPhysics('.'), [0, 0]));
            exports_21("hFence", hFence = new StaticGameObject_5.StaticGameObject([0, 0], new ObjectSkin_12.ObjectSkin(`☗`, '.', { '.': ['Sienna', 'transparent'] }), new ObjectPhysics_10.ObjectPhysics('.'), [0, 0]));
            exports_21("beehive", beehive = new StaticGameObject_5.StaticGameObject([0, 0], new ObjectSkin_12.ObjectSkin(`☷`, `R`, {
                'R': ['black', 'orange'],
...
System.register("world/levels/ggj2020demo/level", ["engine/ObjectSkin", "engine/StaticGameObject", "engine/ObjectPhysics", "utils/misc", "world/objects", "world/levels/glitch", "world/levels/ggj2020demo/tiles", "world/objects/natural", "engine/Npc", "world/npc/Bee", "world/items", "world/objects/artificial"], function (exports_22, context_22) {
    ...
    return {
        ...
        execute: function () {
            vFence = new StaticGameObject_6.StaticGameObject([0, 0], new ObjectSkin_13.ObjectSkin(`☗`, '.', { '.': ['Sienna', 'transparent'] }), new ObjectPhysics_11.ObjectPhysics('.'), [0, 0]);
            hFence = new StaticGameObject_6.StaticGameObject([0, 0], new ObjectSkin_13.ObjectSkin(`☗`, '.', { '.': ['Sienna', 'transparent'] }), new ObjectPhysics_11.ObjectPhysics('.'), [0, 0]);
            ...
            exports_22("level", level = {
                ...
                glitches: [/*glitchyNpc,*/ misc_3.clone(glitch_1.glitch1, { position: [7, 7] })],
                tiles: tiles_1.tiles,
            });
        }
    };
...
System.register("ui/glitchField", ["engine/GraphicsEngine", "engine/Cell", "main", "engine/SceneBase"], function (exports_24, context_24) {
    ...
    return {
        ...
        execute: function () {
            ...
            GlitchField = class GlitchField extends SceneBase_2.SceneBase {
                constructor() {
                    super();
                }
                draw(ctx) {
            ...
            exports_24("GlitchField", GlitchField);
        }
    };
});
System.register("main", ["world/levels/ggj2020demo/level", "world/items", "engine/GameEvent", "engine/EventLoop", "engine/Scene", "engine/Cell", "engine/GraphicsEngine", "world/hero", "ui/playerUi", "engine/Npc", "utils/misc", "ui/glitchField"], function (exports_25, context_25) {
    ...
    return {
        ...
        execute: function () {
            ...
            game = new Game();
            exports_25("viewWidth", viewWidth = 60);
            exports_25("viewHeight", viewHeight = 30);
            exports_25("leftPad", leftPad = (ctx.context.canvas.width - GraphicsEngine_5.cellStyle.size.width * viewWidth) / 2);
            exports_25("topPad", topPad = (ctx.context.canvas.height - GraphicsEngine_5.cellStyle.size.height * viewHeight) / 2);
                    ...
                    while (i < lines.length) {
                        if (lines[i].startsWith(info.name)) {
                            ...
                            for (let k = 0; k < framesCount; k++) {
                                if (k === 0)
                                    sprite.frames[name] = [];
                                sprite.frames[name].push(new ObjectSkin_14.ObjectSkin(bodies[k], colors[k], colorsDict));
                            }
                        }
                        else {
                            i += 1;
...
System.register("world/levels/intro", ["world/objects", "utils/misc", "engine/EventLoop", "engine/GameEvent", "world/npcs"], function (exports_28, context_28) {
    ...
    return {
        ...
        execute: function () {
            exports_28("introLevel", introLevel = [objects_2.house, objects_2.chest, ...objects_2.lamps, ...npcs_1.npcs]);
            // scripts
...
tAA
oEE`;
            exports_29("glitchySprite", glitchySprite = SpriteLoader_1.Sprite.parse(glitchySpriteText));
        }
    };
});
System.register("world/levels/ggj2020demo/npc", ["world/sprites/glitchy", "engine/Npc"], function (exports_30, context_30) {
    ...
    return {
        ...
        execute: function () {
            exports_30("glitchyNpc", glitchyNpc = new class extends Npc_8.Npc {
                constructor() {
                ...
                update(ticks, scene) {
                    ...
                    function getPrayNearby(self, radius) {
                        ...
                        for (const object of scene.objects) {
                            ...
                            if (object === self)
                                continue; // self check
                            if (object instanceof Npc_8.Npc && object.type === "sheep") {
...
System.register("world/npc/Sheep", ["engine/Npc", "engine/ObjectSkin"], function (exports_31, context_31) {
    ...
    return {
        ...
        execute: function () {
            Sheep = class Sheep extends Npc_9.Npc {
                constructor() {
